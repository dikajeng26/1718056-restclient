        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="col-md-6">
                    <a href="<?= base_url(); ?>index.php/dataprodi/tambah" class="btn btn-primary">Tambah
                        Data Prodi</a>
                </div>
            <div class="card">
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?= $dp['prodi']; ?></td>
                    <td>
                        <a href="<?= base_url(); ?>index.php/dataprodi/hapus/<?= $dp['id']; ?>"
                            class="badge badge-danger float-left">hapus</a>
                        <a href="<?= base_url(); ?>index.php/dataprodi/ubah/<?=$dp['id']; ?>"
